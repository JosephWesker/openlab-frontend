...
export default function CoFoundingApplyModal() {
  ...
  // const { isCofounder, isApplicant, loading } = useIsUserCofounder(initiative, userEmail)
  ...
  //     localStorage.setItem('user_cofounding', JSON.stringify([{ email: userEmail, initiativeId: initiative.id }]))
